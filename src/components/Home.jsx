        ...
        <section className="pt-32 pb-20">
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              >
                Welcome to Somnia Data Streams Mini Hackathon, a global, online event from November 4th to November 15th, 2025. Explore SDS - a breakthrough SDK that turns on-chain data into live, structured, and reactive streams. Build apps that react instantly to on-chain events.
              </motion.p>
                      ...
                      <div className="bg-white rounded-2xl shadow-2xl p-6 transform rotate-2 hover:rotate-0 transition-transform duration-300">
                        <div className="flex justify-between items-center mb-6">
                          ...
                          <div className="text-right">
                            <p className="font-bold text-2xl text-emerald-600">Active</p>
                            <p className="text-sm text-emerald-600">Streaming</p>
                          </div>
                        </div>
                        <div className="space-y-4">
                          <div className="h-2 bg-emerald-200 rounded w-3/4" />
                          <div className="h-2 bg-emerald-200 rounded w-1/2" />
...
const featureCards = [
  {
    ...
    icon: <svg className="w-6 h-6 text-emerald-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
  },
  {
    ...
    icon: <svg className="w-6 h-6 text-emerald-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" /></svg>
  },
  {
