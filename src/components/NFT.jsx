      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-400 text-lg">
            Register NFT events on Somnia Data Streams
          </p>
        </motion.div>
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 mb-8">
              Click the button below to instantly register an NFT interaction event on Somnia Data Streams
            </p>
          </div>
          ...
          <div className="mt-8 p-4 bg-gray-800/50 rounded-lg border border-[#8051B8]/20">
            <p className="text-sm text-gray-400 text-center">
              <span className="font-semibold text-[#8051B8]">Event Type:</span> NFT_Sale
            </p>
